...
def signAPK(apkname):	
	...
	platform_json = raw_input("input save filename:\n")
	
	signname = os.path.join(dir_name,"%s-release.apk"%platform_json)
	zipname = os.path.join(dir_name,"%s-align.apk"%platform_json)
